...
class CarouselItem extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement('img', { className: classNames, src: this.props.src, style: this.props.size })
    );
  }
}
  ...
  render() {
    ...
    return React.createElement(
      ...
      this.props.items.map(function (listValue, index) {
        ...
        return React.createElement(CarouselItem, { key: index, name: listValue.name, src: listValue.src, isActive: isActive, size: carouselSize });
      }),
      React.createElement(
        'div',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('img', { src: 'images/icons/arrow-left.svg' })
          ),
          this.props.items.map(function (listValue, index) {
            let isActive = self.state.active == index;
            return React.createElement(CarouselSelect, { key: index, id: index, transition: self.transitionToIndex, isActive: isActive });
          }),
          React.createElement(
            'div',
            { className: 'imgcarousel-arrow imgcarousel-arrow-right', onClick: this.transitionForward },
            React.createElement('img', { src: 'images/icons/arrow-right.svg' })
          )
        )
      )
    );
...
class CarouselSelect extends React.Component {
  ...
  render() {
    ...
    return React.createElement('div', { className: classNames, onClick: this.onClick });
  }
}

ReactDOM.render(React.createElement(ImgCarousel, {
  rotationTime: '8',
  height: '400px',
  width: '100%',
